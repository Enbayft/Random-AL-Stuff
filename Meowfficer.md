The general formula for dual-attribute meowfficer effective stat gains is: 2.16 * ( 2/3 * Main Attribute + 1/3 * Secondary Attribute) / ( 100 + 0.36 * ( 2/3 * Main Attribute + 1/3 * Secondary Attribute))
